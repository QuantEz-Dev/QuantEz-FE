      ...
      <Components.Container>
        <Components.SignUpContainer signinIn = {signIn}>
          <Components.Form >
            ...
            <Components.Input name="name" type="text" placeholder="Name" required=""  />
            <Components.Input name="email" type="email" placeholder="Email" required="" />
            <Components.Input name="password" type="password" placeholder="Password" required=""/>
